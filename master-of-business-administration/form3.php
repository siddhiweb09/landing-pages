<form action="submitLead.php" method="post" onsubmit="return disableButton3()" class="formPanel p-3">
    <h6 class="text-yellow">Admission Open</h6>
    <h4 class="text-blue">Enroll Now for 2025-26</h4>
    <div class="row mt-3">
        <div class="form-group mb-2">
            <input type="text" class="form-control" id="name3" name="name3" placeholder="Enter your Name" required>
        </div>
        <div class="form-group mb-2">
            <input type="email" class="form-control" id="email3" name="email3" placeholder="Enter your Email" required>
        </div>
        <div class="form-group mb-2" style="display: flex;">
            <input type="text" maxlength="10" style="width: 100%;" id="mobile_code3" class="form-control"
                placeholder="Phone Number" name="phone3" autocomplete="off" required>
        </div>

        <div class="form-group col-12 col-lg-6 mb-2">
            <select class="form-control form-select state3" id="state3" name="state3" required>
                <option value>Select State</option>
            </select>
        </div>
        <div class="form-group col-12 col-lg-6 mb-2">
            <select class="form-control form-select city3" id="city3" name="city3" required>
                <option value>Select City</option>
            </select>
        </div>
        <div class="form-group mb-2">
            <select class="form-control form-select course3" id="course3" name="course3" required>
        ...
        <select class="level" id="level" name="level" hidden style="display: none;">
        ...
        <div class="form-group d-flex justify-content-center">
            <input type="submit" id="submitButton3" name="submit" value="Apply Now" class="btn banner-button btn-og" />
        </div>
    </div>
</form>
...
<script>
    function disableButton3() {
        ...
        submitButton3.value = "Submitting...";
        return true;
    }
</script>